...
<template>
  <q-drawer v-model="drawer" :width="sysStore.systemSettings.user.drawerWidth" :breakpoint="0"
    :mini="sysStore.systemSettings.user.drawerWidth < miniChangeWidth"
    :mini-width="Math.min(miniChangeWidth, sysStore.systemSettings.user.drawerWidth)" class="column"
    style="height: 100vh;">
    ...
    <icon-button-view :icon-src="assets.svg.menuicon_open" :label="$t('worldList.allWorld')"
      @click="sysStore.systemSettings.user.drawerWidth = 100" class="q-mini-drawer-hide" />
