    ...
    >
      <div class="q-pb-sm">
        <div class="caption" style="opacity: 0.6">
          {{ $t('shareWorld.addRemote.account') }}
        </div>
        <SsSelect
          dense
          v-model="accountType"
          :options="[{ label: $t('shareWorld.github'), value: 'github' }]"
          option-label="label"
          option-value="value"
        />
      </div>
      <div class="q-py-sm">
        <div class="caption" style="opacity: 0.6">
          {{ $t('shareWorld.addRemote.user') }}
        </div>
        <SsInput
          dense
          v-model="ownerName"
          :rules="[
            (val) => val !== '' || $t('shareWorld.addRemote.inputValue'),
          ]"
        />
      </div>
      <div v-show="accountType === 'github'">
        <div class="q-py-sm">
          <div class="caption" style="opacity: 0.6">
            {{ $t('shareWorld.addRemote.repository') }}
          </div>
          <SsInput
            dense
            v-model="repoName"
        ...
        <div class="q-py-sm">
          <div class="caption" style="opacity: 0.6">Personal Access Token</div>
          <SsInput
            dense
            secret
            v-model="pat"
