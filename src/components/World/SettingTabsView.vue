  ...
  >
    <template v-if="$router.currentRoute.value.path.slice(0, 7) !== '/system'">
      <icon-tab-view
        path=""
        icon="home"
        :label="$t('tabs.worldSettingTabs.home')"
      />
      <icon-tab-view
        path="console"
        icon="terminal"
        :label="$t('tabs.worldSettingTabs.console')"
      />
      <icon-tab-view
        path="property"
        icon="list"
        :label="$t('tabs.worldSettingTabs.property')"
      />
      <icon-tab-view
        path="player"
        icon="person"
        :label="$t('tabs.worldSettingTabs.player')"
      />
      <icon-tab-dropdown-view
        v-model="contentsStore.selectedTab"
        path="contents"
        icon="extension"
        :label="$t('tabs.worldSettingTabs.contents')"
      ...
      <icon-tab-view
        path="others"
        icon="build"
        :label="$t('tabs.worldSettingTabs.others')"
      />
    </template>
    <template v-else>
      <icon-tab-view
        path="system"
        icon="home"
        :label="$t('tabs.systemSettingTabs.home')"
      />
      <icon-tab-view
        path="system/property"
        icon="list_alt"
        :label="$t('tabs.systemSettingTabs.list_alt')"
      />
      <!-- <icon-tab-view path="system/remote" icon="cloud" :label="$t('tabs.systemSettingTabs.cloud')" /> -->
      <icon-tab-view
        path="system/folder"
        icon="folder"
        :label="$t('tabs.systemSettingTabs.folder')"
      />
      <icon-tab-view
        path="system/info"
        icon="info"
        :label="$t('tabs.systemSettingTabs.info')"
      />
    </template>
  </q-tabs>
