export const jaHome = {
  ...
  versionChange: {
    title: 'サーバーの種類を変更',
    desc: '以前起動したサーバーの種類を変更する操作は，ワールドデータが破損する恐れがあります．<br>危険性を理解した上でバージョンの変更を行いますか？',
    okbtn: '危険性を理解して変更する',
  },
  versionDown: {
    title: 'バージョンダウンの確認',
    desc: '以前起動したサーバーのバージョンからバージョンを下げる操作は，ワールドデータが破損する恐れがあります．<br>危険性を理解した上でバージョンの変更を行いますか？',
    okbtn: '危険性を理解して変更する',
  },
  serverType: {
    vanilla: 'バニラ (公式)',
